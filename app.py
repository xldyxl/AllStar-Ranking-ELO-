...
column_config = {
    ...
    "17시즌 경기 수": st.column_config.NumberColumn("17시즌 경기 수", alignment="center", format="%d", width="small"),
    "승": st.column_config.NumberColumn("승", alignment="center", format="%d", width="small"),
    "무": st.column_config.NumberColumn("무", alignment="center", format="%d", width="small"),
    "패": st.column_config.NumberColumn("패", alignment="center", format="%d", width="small"),
}
